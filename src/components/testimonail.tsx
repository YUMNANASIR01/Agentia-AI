    ...
    <div className="max-w-sm mx-auto bg-slate-800 p-6 rounded-xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
      ...
      <div className="mt-4">
        <svg
          ...
          stroke="currentColor"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.25 9l6 6 6-6" />
        </svg>
      </div>
    </div>
  )
...
export default function Testimonials() {
  const testimonials = [
    ...
    },
    {
      name: "Jane Smith",
      title: "CTO, TechCorp",
      testimonial: "Incredible service! The user interface is intuitive and the customer support is top-notch.",
    ...
    },
    {
      ...
      testimonial: "The product helped us streamline our operations and we saw immediate results.",
